...
class ResetPasswordController extends AbstractController
{
    ...
    {
        //Récupére le token stocker en session et envoi dans le render
...
//Commenter pour ne pas envoyer le mail de reset
/*        $email = (new TemplatedEmail())
            ->from(new Address('admin@sortir-eni.com', 'Administrateur'))
            ->to($user->getMail())
